...
--
-- Хост: 127.0.0.1
-- Время создания: Апр 27 2024 г., 19:57
...
(2, '2024_03_06_131413_create_users_table', 1),
(3, '2024_04_13_064822_create_reviews_table', 1),
(4, '2024_04_13_064855_create_products_table', 1),
(5, '2024_04_13_064911_create_carts_table', 1),
(6, '2024_04_13_064922_create_orders_table', 1);
...
(1, 'Супер сет Филадельфия', 'sets', NULL, '1200'),
(2, 'Супер сет Калифорния', 'sets', NULL, '1200'),
(3, 'Супер сет МИКС', 'sets', NULL, '1150'),
(4, 'Сет Филадельфия', 'sets2', NULL, '998'),
(5, 'Сет “Казино”', 'sets2', NULL, '998'),
(6, 'Сет “Ночной дожор”', 'sets2', NULL, '998'),
(7, 'Мини Филадельфия', 'setsforone', NULL, '450'),
(8, 'Мини Калифорния', 'setsforone', NULL, '450'),
(9, 'Мини Онигири', 'setsforone', NULL, '450'),
(10, 'Сливочный суп с лососем', 'hot', NULL, '289'),
(11, 'Домашний борщ', 'hot', NULL, '199'),
(12, 'Рамен по-корейски', 'hot', NULL, '320'),
(13, 'Ванильный шейк', 'drinks', NULL, '199'),
(14, 'Клубничный шейк', 'drinks', NULL, '199'),
(15, 'Лимонный шейк', 'drinks', NULL, '199');
...
INSERT INTO `users` (`id`, `name`, `phone_number`, `password`, `adress`, `floor`, `entrance`, `apartment`, `created_at`, `updated_at`) VALUES
(1, 'Иван', '+79210260266', '$2y$12$CIWYtsW6jlERfUGuMujQv.styE5uEqYqq6yEWjXvjnQwDUySZJMkW', NULL, NULL, NULL, NULL, '2024-04-27 10:00:22', '2024-04-27 10:00:22'),
(2, 'Иван', '+79657800839', '$2y$12$xu.xjNdSTFcHyoNpT6alhOJZ7P6KtxEBiWRMGQ7gK3Zk3G4c8h9ie', NULL, NULL, NULL, NULL, '2024-04-27 13:58:04', '2024-04-27 13:58:04');
...
('root', '[{\"db\":\"db\",\"table\":\"carts\"},{\"db\":\"db\",\"table\":\"products\"},{\"db\":\"db\",\"table\":\"users\"},{\"db\":\"db\",\"table\":\"personal_access_tokens\"},{\"db\":\"db\",\"table\":\"post\"}]');
...
('root', 'db', 'users', '{\"CREATE_TIME\":\"2024-03-16 09:11:34\"}', '2024-04-24 18:19:07');
...
('root', '2024-04-27 14:20:55', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"ru\"}');
...
ALTER TABLE `pma__savedsearches`
  MODIFY `id` int(5) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- База данных: `sushispot_db`
--
CREATE DATABASE IF NOT EXISTS `sushispot_db` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `sushispot_db`;
